from PySide6.QtWidgets import QTableWidgetItem, QTableWidget, QLineEdit, QComboBox # Added QComboBox
...
class ControladorPantallaCorridas:
    ...
    def _setup_ui(self):
        ...
        # New: Find and connect comboBox_filtroOrigenCorr
    ...
    def _on_filtro_origen_changed(self, index):
        if self.comboBox_filtroOrigenCorr:
            ...
            if index == 0 and (self.filtro_origen == "Seleccione..." or self.filtro_origen == "All"): # Adjusted for potential default/all options
                self.filtro_origen = ""
            self._aplicar_filtros()
