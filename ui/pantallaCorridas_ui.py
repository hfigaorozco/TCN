...
################################################################################
## Form generated from reading UI file 'pantallaCorridas.ui'
##
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_filtroDestinoCorr.setItemText(0, QCoreApplication.translate("Form", u"Ensenada", None))
        self.comboBox_filtroDestinoCorr.setItemText(1, QCoreApplication.translate("Form", u"Mexicali", None))
        self.comboBox_filtroDestinoCorr.setItemText(2, QCoreApplication.translate("Form", u"San Felipe", None))
        self.comboBox_filtroDestinoCorr.setItemText(3, QCoreApplication.translate("Form", u"San Quint\u00edn", None))
        self.comboBox_filtroDestinoCorr.setItemText(4, QCoreApplication.translate("Form", u"Tecate", None))
        self.comboBox_filtroDestinoCorr.setItemText(5, QCoreApplication.translate("Form", u"Tijuana", None))
        ...
        self.comboBox_filtroOrigenCorr.setItemText(0, QCoreApplication.translate("Form", u"Ensenada", None))
        self.comboBox_filtroOrigenCorr.setItemText(1, QCoreApplication.translate("Form", u"Mexicali", None))
        self.comboBox_filtroOrigenCorr.setItemText(2, QCoreApplication.translate("Form", u"San Felipe", None))
        self.comboBox_filtroOrigenCorr.setItemText(3, QCoreApplication.translate("Form", u"San Quint\u00edn", None))
        self.comboBox_filtroOrigenCorr.setItemText(4, QCoreApplication.translate("Form", u"Tecate", None))
        self.comboBox_filtroOrigenCorr.setItemText(5, QCoreApplication.translate("Form", u"Tijuana", None))
