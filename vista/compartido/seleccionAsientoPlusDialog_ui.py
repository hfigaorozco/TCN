...
class SeleccionAsientoPlus(object):
    def setupUi(self, Dialog):
        ...
        self.label_titulo.setStyleSheet("font-size: 32pt; font-weight: bold; color: #1877F2;")
        ...
        self.frame_asientos.setGeometry(QRect(120, 280, 410, 530))
        ...
        self.layoutWidget.setGeometry(QRect(10, 10, 390, 510))
        self.gridLayout = QGridLayout(self.layoutWidget)
        self.gridLayout.setSpacing(10)
        
        # CREAR 44 BOTONES DE ASIENTOS (PLUS)
        self.asientos = []
        asiento_ids = [
        ...
        # LAYOUT 2-2 CON PASILLO EN MEDIO (columnas: 0,1 = izq | 2=pasillo | 3,4 = der)
        row = 0
        ...
        self.frame_botones.setGeometry(QRect(150, 825, 350, 60))
