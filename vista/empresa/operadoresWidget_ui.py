...
################################################################################
## Form generated from reading UI file 'operadoresWidget.ui'
##
...
"")
    ...
    def retranslateUi(self, pagina_operadores):
        ...
        self.lineEdit_nombre.setInputMask(QCoreApplication.translate("pagina_operadores", u">A<AAAAAAAAAAAAAA", None))
        self.label_estatico_apellidop.setText(QCoreApplication.translate("pagina_operadores", u"Apellido Parterno", None))
        self.lineEdit_apellidop.setInputMask(QCoreApplication.translate("pagina_operadores", u">A<AAAAAAAAAAAAAA", None))
        self.label_estatico_apellidom.setText(QCoreApplication.translate("pagina_operadores", u"Apellido Materno", None))
        self.lineEdit_apellidom.setInputMask(QCoreApplication.translate("pagina_operadores", u">A<AAAAAAAAAAAAAA", None))
        self.label_estatico_telefono.setText(QCoreApplication.translate("pagina_operadores", u"Telefono", None))
        self.lineEdit_telefono.setInputMask(QCoreApplication.translate("pagina_operadores", u"9999999999", None))
